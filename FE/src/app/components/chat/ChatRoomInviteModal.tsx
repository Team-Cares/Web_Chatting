...
export default function ChatRoomInviteModal({
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-6 rounded-lg w-[500px] h-[700px] md:h-[450px] sm:h-[400px]">
        ...
        <div className="overflow-y-auto h-[600px] mt-4 scrollbarCustom md:h-[350px] sm:h-[300px]">
          <ChatFriendList
            friends={friendsData}
            onClose={onClose}
